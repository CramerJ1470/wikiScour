...
//************************Create Class SchoolObjects*****************/
    ...
    constructor (array) {
      ...
      makeArray() {
        ...
        for (let a=0; a < this.array.length; a++) {
          Object.defineProperty(newItem, this.array, {value:this.array.value});list.push(newItem);}
          return list;
      }
    }
  ...
  //********************Getting college pictures off wikipedia page*************/
  //*********************Idea to cycle through them*****************************/
  let getCollegePictures = document.getElementsByClassName("mw-file-description");
  
  let hrefarray = [] ;for (let a =0 ; a < getCollegePictures.length; a++) {hrefarray.push(getCollegePictures[a].href);}
...
let newSchoolItems = new IndividualSchool(school);
console.log("newSchoolItrems:",newSchoolItems.makeArray());
